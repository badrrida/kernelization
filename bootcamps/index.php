...
<link rel="stylesheet" href="planetviewer.css">
...
<div class="container" id="mobile_control">
	...
	<div class="carousel">
		...
		<div class="citem active" id="p0">
			<h1><i class="fas fa-times" id="closemodal"></i> Conquering Strategy</h1>
			<p>
		...
		<div class="citem" id="p3">
			<h1><i class="fas fa-times" id="closemodal1"></i> Conquering Strategy</h1>
			<p>
		...
		<div class="citem" id="p2">
			<h1><i class="fas fa-times" id="closemodal2"></i> Conquering Strategy</h1>
			<p>
		...
		<div class="citem" id="p4">
			<h1><i class="fas fa-times" id="closemodal4"></i> Conquering Strategy</h1>
			<p>
		...
		<div class="citem" id="p5">
			<h1><i class="fas fa-times" id="closemodal5"></i> Conquering Strategy</h1>
		...
		<div class="citem" id="p6">
			<h1><i class="fas fa-times" id="closemodal6"></i> Conquering Strategy</h1>
		...
		<div class="citem" id="p7">
			<h1><i class="fas fa-times" id="closemodal7"></i> Conquering Strategy</h1>
	...
	<div class="content">
		...
		<div class="helmet">
			<img ondragstart="return false;" src="http://i65.tinypic.com/2ut111x.png"/>
	...
	<div class="bottom">
		<div class="nav">
			<span class="action"><i class="material-icons"></i></span>
			<span id="next" class="action"><i class="material-icons">keyboard_arrow_right</i></span>
		</div>
		<div class="orbit">
...
<script type="text/javascript" src="planetviewer.js"></script>