...
$("#closemodal, #closemodal1, #closemodal2, #closemodal3, #closemodal4, #closemodal5, #closemodal6, #closemodal7").on("click", function(){
  closemodal();
});
